...
export const misPatronesStyles = StyleSheet.create({
  ...
  // Header morado igual al resto de pantallas
  header: {
    backgroundColor: PURPLE,
    paddingHorizontal: 20,
  ...
  // Cards de patrones — imagen grande arriba, info abajo
  listaPatrones: {
    padding: 16,
    gap: 16,
  },
  ...
  /* CAMBIO: cardInfo es el recuadro morado debajo de la imagen
     con texto en blanco, más alto para mejor visualización */
  cardInfo: {
    backgroundColor: PURPLE,
    paddingHorizontal: 16,
    paddingVertical: 14,   /* CAMBIO: aumentado de 8 a 14 para más altura */
    gap: 4,
  },
  cardNombre: {
    fontSize: 16,
    fontWeight: 'bold',
    color: 'white',       /* CAMBIO: blanco sobre fondo morado */
  },
  cardCreador: {
    fontSize: 13,
