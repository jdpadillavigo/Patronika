...
export default function AdminBottomBar({activeItem,
  onPressUsers,
  onPressCommunity,
  onPressTutorials,
  onPressProfile,
  ...
  const isTutorialsActive = activeItem === AdminBottomNavigationItem.TUTORIAL_MANAGEMENT;
  const isProfileActive = activeItem === AdminBottomNavigationItem.PROFILE;

  return (
    <View style={styles.wrapper}>
      {/* Barra de navegación admin: slots de igual flex, sin FAB central */}
      <View style={[styles.navBar, styles.adminNavBar]}>
        <TouchableOpacity style={styles.navItem} onPress={onPressUsers} activeOpacity={0.75}>
          <Ionicons name={isUsersActive ? 'people' : 'people-outline'} size={23} color={isUsersActive ? PURPLE : colors.iconMuted} />
        ...
        <TouchableOpacity style={styles.navItem} onPress={onPressCommunity} activeOpacity={0.75}>
          <Ionicons name={isCommunityActive ? 'home' : 'home-outline'} size={23} color={isCommunityActive ? PURPLE : colors.iconMuted} />
        ...
        <TouchableOpacity style={styles.navItem} onPress={onPressTutorials} activeOpacity={0.75}>
          ...
          <Text style={[styles.navLabel, isTutorialsActive && styles.navLabelActive]}>Gestión de Tutoriales</Text>
        </TouchableOpacity>
